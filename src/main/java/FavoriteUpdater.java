...
public class FavoriteUpdater extends Thread{
    ...
    public void run() {
        try {
                ...
                if (!queue.isEmpty()) {
                    ...
                    switch ((String) qd.get("type")) {
                        case "start": {
                            ...
                            cm.connectToServer(client, new URI("ws://swarm.solidarbet.com:8087"));
            ...
            main.sendNotification("Favorite updater crash", new Date()+"\n\n  Favorite updater stopped");
        }
    }
    ...
    public void build_data(Set<String> sids_u, JSONObject sport)
    {
        try
        {
            ...
            tQ.put("latch",tL);
            main.favTotals.getQueue().put(tQ);
            tL.await();
